...
# click button dropdown atur 
driver.find_element_by_xpath('//*[@data-testid="btnAdminListActions"]').click()

# Click cta delete admin 
driver.find_element_by_xpath('//*[@data-testid="btnAturHapusAdmin"]').click()

# click button confirm delete admin 
driver.find_element_by_xpath('//button[@class="css-evb2vf-unf-btn e1ggruw00"]').click()

# choose verification method PIN tokopedia
