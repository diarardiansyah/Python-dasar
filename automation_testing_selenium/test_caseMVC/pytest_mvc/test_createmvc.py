...
def test_create():
    time.sleep(3)
    driver.find_element_by_xpath('//*[@data-testid="btnVoucherGlobalPrimary"]').click()
    driver.find_element_by_xpath('//*[@data-testid="btnVoucherCreateModalShipping"]').click()
    driver.find_element_by_xpath('//*[@data-testid="txtVoucherName"]').send_keys('testvoucher')
